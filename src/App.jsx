...
import { validateFormula, validateGenericFormula } from './utils/formulaValidator.js';
          ...
          <section className="rounded-[2rem] border border-coach-line bg-white p-4 shadow-soft dark:border-white/10 dark:bg-white/[0.055]">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-xl font-black">Level {exerciseIndex + 1} dari {exerciseCount}: {exercise.title.replace(/^Latihan \d+:\s*/, '')}</h3>
              </div>
