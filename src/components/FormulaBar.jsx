    ...
    <div className="rounded-[1.5rem] border border-coach-line bg-white p-3 shadow-soft dark:border-white/10 dark:bg-white/[0.055]">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <input
          ...
          className="min-h-[46px] flex-1 rounded-xl border border-coach-line bg-coach-beige px-4 font-mono text-sm font-semibold outline-none transition focus:border-coach-green dark:border-white/10 dark:bg-black/20 dark:text-white"
        />
      </div>
