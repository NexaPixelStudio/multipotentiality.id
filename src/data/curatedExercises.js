...
export const sharedExerciseTables = {
  ...
  "lookup": {
    ...
    "description": "Kolom A-C adalah transaksi. Kolom F-I adalah master produk.",
    "columns": [
      "Kode Produk",
...
export const curatedExercises = {
  ...
  "vlookup": {
    ...
    "tableKey": "lookup",
    "activeCell": "G2",
    "question": "Ambil Nama Produk untuk kode transaksi di A2 dari master produk.",
    "logicPrompt": "Cari kunci datanya dulu, lalu pastikan range pengambilannya sejajar dengan kunci tersebut.",
    "expectedFormula": "=VLOOKUP(A2,E2:H8,2,FALSE)",
    "acceptedFormulas": [],
    "requiredRefs": [
      "A2",
      "E2:H8"
    ...
    "hints": [
      "Tentukan dulu hasil akhir yang diminta soal.",
      "Range yang perlu kamu perhatikan: A2, E2:H8.",
  ...
  "hlookup": {
    ...
    "activeCell": "G2",
    "question": "Ambil Harga untuk kode produk P-003 dari tabel horizontal.",
    "logicPrompt": "Cari kunci datanya dulu, lalu pastikan range pengambilannya sejajar dengan kunci tersebut.",
    "expectedFormula": "=HLOOKUP(\"P-003\",A1:H4,2,FALSE)",
    "acceptedFormulas": [],
    "requiredRefs": [
      "A1:H4"
    ],
  ...
  "match": {
    ...
    "tableKey": "lookup",
    "activeCell": "G2",
    "question": "Cari posisi kode transaksi A2 di kolom Master Kode.",
    "logicPrompt": "Cari kunci datanya dulu, lalu pastikan range pengambilannya sejajar dengan kunci tersebut.",
  ...
  "index_match": {
    ...
    "tableKey": "lookup",
    "activeCell": "G2",
    "question": "Ambil Nama Produk transaksi A2 dengan gabungan INDEX dan MATCH.",
    "logicPrompt": "Cari kunci datanya dulu, lalu pastikan range pengambilannya sejajar dengan kunci tersebut.",
  ...
  "xmatch": {
    ...
    "tableKey": "lookup",
    "activeCell": "G2",
    "question": "Cari posisi kode transaksi A2 di Master Kode memakai XMATCH.",
    "logicPrompt": "Cari kunci datanya dulu, lalu pastikan range pengambilannya sejajar dengan kunci tersebut.",
  ...
  "rows": {
    ...
    "hints": [
      "Tentukan dulu hasil akhir yang diminta soal.",
      "Range yang perlu kamu perhatikan: E2:H8.",
      "Cocokkan urutan argumen dengan syntax rumusnya.",
      "Cek separator sesuai mode Excel yang kamu pilih."
    ],
