...
const strictTableRules = {
  ...
  'Math and Trigonometry': ['mathNumbers', 'sales', 'students', 'dynamic', 'forecast'],
  Statistical: ['statsNegBinom', 'statsBinom', 'statsNormal', 'statsBetaGamma', 'statsFreedom', 'statsActualExpected', 'statsSeriesCompact', 'students', 'forecast'],
