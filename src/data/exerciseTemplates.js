export function createGenericExercise(formula) {
  ...
  return {
    ...
    activeCell: 'C2',
    question: `Coba tulis formula ${formula.name} sederhana berdasarkan syntax yang tersedia. Fokus dulu ke struktur, bukan hasil angka final.`,
    ...
    hints: [
      ...
      'Isi argumen sesuai syntax. Tidak perlu sempurna, yang penting strukturnya mendekati.',
    ...
    formulaParts: [
      ...
      'Urutan argumen mengikuti syntax yang ditampilkan di halaman teori.'
    ],
    commonMistakes: [
