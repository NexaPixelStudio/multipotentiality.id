...
const exercises = {
  ...
  average: [
    ...
    { title: 'Tantangan', question: 'Berapa rata-rata penjualan dari Juli sampai Desember?', logic: 'Pilih range Juli sampai Desember saja, lalu gunakan AVERAGE.', expectedFormula: '=AVERAGE(B8:B13)', hints: nRangeHints('rata-rata penjualan Juli sampai Desember', 'B8:B13') }
  ],
  min: [
    ...
    { title: 'Tantangan', question: 'Berapa penjualan paling kecil dari Juli sampai Desember?', logic: 'Range dibatasi Juli sampai Desember agar MIN hanya membaca data bulan yang diminta.', expectedFormula: '=MIN(B8:B13)', hints: nRangeHints('penjualan paling kecil Juli sampai Desember', 'B8:B13') }
  ],
  max: [
    ...
    { title: 'Tantangan', question: 'Berapa penjualan paling besar dari Juli sampai Desember?', logic: 'Range dibatasi Juli sampai Desember agar MAX hanya membaca data bulan yang diminta.', expectedFormula: '=MAX(B8:B13)', hints: nRangeHints('penjualan paling besar Juli sampai Desember', 'B8:B13') }
  ],
  large: [
  ...
  countif: [
    ...
    { title: 'Tantangan', question: 'Berapa jumlah produk yang berada di kota Bandung?', logic: 'Fokus pada kolom Kota, lalu hitung baris yang berisi Bandung.', expectedFormula: '=COUNTIF(C2:C13,"Bandung")', hints: oneCriteriaHints({ goal: 'jumlah produk di Bandung', criteriaRange: 'C2:C13', criteria: '“Bandung”', functionName: 'COUNTIF' }) }
  ],
  sumif: [
