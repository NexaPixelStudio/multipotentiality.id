...
const labelByIndex = ['Dasar', 'Range Lain', 'Syarat', 'Multi Data', 'Validasi', 'Lanjutan'];
...
const exercises = {
  ...
  min: [
    ...
    { title: 'Januari sampai Juni', question: 'Berapa penjualan paling kecil dari Januari sampai Juni?', logic: 'Range dibatasi Januari sampai Juni agar MIN hanya membaca bulan yang diminta.', expectedFormula: '=MIN(B2:B7)', hints: nRangeHints('penjualan paling kecil Januari sampai Juni', 'B2:B7') },
    { title: 'Juli sampai Desember', question: 'Berapa penjualan paling kecil dari Juli sampai Desember?', logic: 'Range dibatasi Juli sampai Desember agar MIN hanya membaca bulan yang diminta.', expectedFormula: '=MIN(B8:B13)', hints: nRangeHints('penjualan paling kecil Juli sampai Desember', 'B8:B13') }
  ],
  max: [
    ...
    { title: 'Januari sampai Juni', question: 'Berapa penjualan paling besar dari Januari sampai Juni?', logic: 'Range dibatasi Januari sampai Juni agar MAX hanya membaca bulan yang diminta.', expectedFormula: '=MAX(B2:B7)', hints: nRangeHints('penjualan paling besar Januari sampai Juni', 'B2:B7') },
    { title: 'Juli sampai Desember', question: 'Berapa penjualan paling besar dari Juli sampai Desember?', logic: 'Range dibatasi Juli sampai Desember agar MAX hanya membaca bulan yang diminta.', expectedFormula: '=MAX(B8:B13)', hints: nRangeHints('penjualan paling besar Juli sampai Desember', 'B8:B13') }
  ],
  large: [
  ...
  countif: [
    ...
    { title: 'Kota Bandung', question: 'Berapa jumlah produk dari kota Bandung?', logic: 'Fokus pada kolom Kota, lalu hitung baris yang berisi Bandung.', expectedFormula: '=COUNTIF(C2:C13,"Bandung")', hints: oneCriteriaHints({ goal: 'jumlah produk dari Bandung', criteriaRange: 'C2:C13', criteria: '“Bandung”', functionName: 'COUNTIF' }) }
  ],
  sumif: [
